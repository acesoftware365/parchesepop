          ...
          return ListView(
            ...
            children: [
              ...
              const _SectionTitle(
                ...
                title: 'MISIONES DE MODOS',
                subtitle: 'Termina partidas en Quick Pop y Caos.',
              ),
              const SizedBox(height: 10),
              _MissionCard(
                key: const ValueKey('mission-quick-pop-matches'),
                icon: Icons.rocket_launch_rounded,
                title: 'Juega 2 partidas de Quick Pop',
                value: daily.quickPopMatches,
                target: daily.quickPopTarget,
                reward: progression.policy.quickPopMatchesCoins,
                claimed: daily.quickPopRewardClaimed,
                accent: const Color(0xFF7257E9),
              ),
              const SizedBox(height: 10),
              _MissionCard(
                key: const ValueKey('mission-chaos-match'),
                icon: Icons.auto_awesome_rounded,
                title: 'Termina una partida de Caos',
                value: daily.chaosMatches,
                target: daily.chaosTarget,
                reward: progression.policy.chaosMatchesCoins,
                claimed: daily.chaosRewardClaimed,
                accent: const Color(0xFFFF5964),
              ),
              const SizedBox(height: 20),
              const _SectionTitle(
