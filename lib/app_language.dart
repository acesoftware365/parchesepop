...
const _privacyDescription =
    'La aplicación guarda localmente el perfil, las monedas, las compras cosméticas y las preferencias. Google Analytics recopila eventos de uso, como el inicio de una partida rápida o contra CPU, el modo y la dificultad. No enviamos el nombre, el correo, los mensajes, la bandera ni el avatar.';
...
const _english = <String, String>{
  ...
  _privacyDescription:
      'The app stores the profile, coins, cosmetic purchases, and preferences locally. Google Analytics collects usage events, such as whether a quick match or CPU match starts, the mode, and the difficulty. We do not send the name, email, messages, flag, or avatar.',
